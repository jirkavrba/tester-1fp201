defmodule Tester1fp201Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(Tester1fp201Web.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(Tester1fp201Web.Gettext, "errors", msg, opts)
    # end
